...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone II" ENABLE_RUNTIME_MOD="NO" INIT_FILE="centroid_indicator.mif" NUMWORDS_A=64 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=1 WIDTH_BYTEENA_A=1 WIDTHAD_A=6 address_a clock0 q_a
...
module  centroid_target_image_rom_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "centroid_indicator.mif",
		ram_block1a_0.init_file_layout = "port_a",
		ram_block1a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_0.mem_init0 = 64'h007E665A5A667E00,
...
endmodule //centroid_target_image_rom_altsyncram
//VALID FILE
...
`endif
	...
	centroid_target_image_rom_altsyncram	centroid_target_image_rom_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
